---
title: Sussex, Beechwood and who gets to belong
date: 2026-01-30 00:00:00 Z
tags:
- Housing
subtitle: Preserving character or perpetuating exclusion?
author: Sharon Nyangweso
featured-image: "/assets/img/sussex-blocks.png"
layout: post
featured: true
---
...
@media (max-width: 480px) {
  ...
  .op-ed-body p:first-of-type:first-letter {
    initial-letter: 1;
    float: none;
  }
}
...
<div class="development-renderings">
  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
      <figure class="rendering-figure">
        <img src="/assets/img/sussex-blocks.png" 
             alt="NCC renderings of proposed Sussex Blocks development across the street from the Embassy of France" 
             class="img-fluid rounded shadow-sm">
      </figure>
    </div>
    <div class="col-md-6 mb-4">
      <figure class="rendering-figure">
        <img src="/assets/img/sussex-blocks2.png" 
             alt="Rendering of proposed Sussex Blocks development aerial view" 
             class="img-fluid rounded shadow-sm">
      </figure>
    </div>
  </div>
  
  <p class="rendering-credit text-center mt-2">
    <small>NCC renderings of proposed Sussex Blocks development across the street from the Embassy of France</small>
  </p>
</div>
